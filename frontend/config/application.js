...
module.exports = require(process.env['LINEMAN_MAIN']).config.extend('application', {
  ...
  prependTasks: {
    ...
    common: ["haml", "copy", "ngtemplates"] // ngtemplates runs in dist and dev
  },
  ...
  ngtemplates: {
    app: { // "app" matches the name of the angular module defined in app.js
      options: {
        base: "generated/templates/app/templates"
      },
      src: "generated/templates/app/templates/**/*.html",
  ...
  watch: {
    ...
    copy: {
      ...
      tasks: ["copy", "ngtemplates", "concat_sourcemap:js"]
    },
    js: {
